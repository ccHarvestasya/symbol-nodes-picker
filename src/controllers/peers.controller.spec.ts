  ...
  it('registerNewPeer', async () => {
    ...
    const mockPeerDocCheckedOldest = [
      ...
      },
      {
        ...
        nodePublicKey:
          '74A443A184CD2BB6164A831C8F245CA87A9B64BDA696A2A17D524F2FF1A2B074',
        port: 7900,
      ...
      },
      {
        ...
        nodePublicKey:
          '45AF1B5B8F83EA2F1E0701C50203BAB7BBBDE8F06E5547354D2DD1EF586B0507',
        port: 7900,
      ...
      },
      {
        ...
        nodePublicKey:
          'AAC168F82C89AAA5EC72B3E93C8F2F1E84D2C6D38CA98A7D93F5F8ACD9AE3490',
        port: 7900,
    ...
    const spyRegisterNewPeer = jest
      .spyOn(service, 'registerNewPeer')
